...
<body>
    <div class="container">
        <img src="user-img/12.jpg" class="profile-img" alt="Profile">
        <h3 class="font-effect-anaglyph user">Reyneil Puda</h3>
        <form action="/admin">
            <div class="input-group w-25 passform">
                <input type="password" class="form-control" placeholder="Password" aria-label="UserPass" aria-describedby="button-addon2">
